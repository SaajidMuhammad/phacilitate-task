  ...
  <section id="about" className="bg-white px-5 py-16 sm:px-8 md:py-24 lg:px-10">
    <AnimatedSection className="mx-auto max-w-[1200px] text-center">
      <motion.span
        ...
        className="mb-3 inline-block text-xs font-medium uppercase tracking-[0.15em] text-[var(--text-muted)]"
      >
        About Us
      </motion.span>
      ...
      <motion.h2
        variants={itemVariants}
        className="mx-auto max-w-md text-[28px] font-bold leading-[1.15] tracking-tight text-[var(--navy)] sm:text-[34px] md:text-[40px]"
      >
      ...
      <motion.p
        variants={itemVariants}
        className="mx-auto mt-4 max-w-md text-[15px] leading-relaxed text-[var(--text-muted)]"
      >
